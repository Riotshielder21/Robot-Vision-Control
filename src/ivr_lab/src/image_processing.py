...
class image_converter:
    ...
    def callback(self, data):
        ...
        if (jointCentres[0][0]-jointCentres[1][0]) != 0:
              link1 = np.arctan((jointCentres[0][1]-jointCentres[0][1])/(jointCentres[0][0]-jointCentres[1][0]))
        else:
              link1 = 0
        if (jointCentres[1][0]-jointCentres[2][0]) != 0:
              link2 = np.arctan((jointCentres[1][1]-jointCentres[2][1])/(jointCentres[1][0]-jointCentres[2][0]))
        else:
              link2 = 0
        if (jointCentres[2][0]-jointCentres[3][0]) != 0:
              link3 = np.arctan((jointCentres[2][1]-jointCentres[3][1])/(jointCentres[2][0]-jointCentres[3][0]))
        else:
              link3 = 0
